...
public class ConsultationController {
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        List<TestRequest> testRequests = testRequestQueryService.findByDoctor(usr);
        return  testRequests;
        //throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            // replace this line of code with your implementation
            User usr = userLoggedInService.getLoggedInUser();
            TestRequest testReq = testRequestUpdateService.assignForConsultation(id,usr);
            return testReq;
            //throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            ...
            //throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
            User usr = userLoggedInService.getLoggedInUser();
            TestRequest testReq = testRequestUpdateService.updateConsultation(id, testResult, usr);
            return testReq;
